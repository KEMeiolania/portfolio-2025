  ...
  return (
    <div className="min-h-screen w-full max-w-[1100px] mx-auto px-6 md:px-12 py-16 flex flex-col font-sans selection:bg-white/20 selection:text-white overflow-x-hidden">
          ...
          <div className="oled-glow border border-[#ffffff05] rounded-[2px] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-6 text-sm md:text-base text-[#a0a0a0] leading-7 font-light font-sans">
                ...
                <p>
                  The immense wealth and population, siphoned by land finance and rapid development, converged here, turning the city into an <span className="text-white italic font-serif">ocean of stars</span>.
                </p>
              </div>
              <div className="space-y-6 text-sm md:text-base text-[#a0a0a0] leading-7 font-light font-sans border-l border-[#ffffff0a] pl-0 md:pl-12">
                <p>
                  Today, ten million active agents navigate this region daily. It is a complex <strong className="text-white font-normal">information system</strong>.
                </p>
                <p>
                  To truly understand the economic and political logic beneath this expansion, I must delve into the data generated by human interactions.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="pl-8 md:pl-12 relative">
          ...
          <div className="border border-[#ffffff0a] bg-[#050505] p-8 md:p-10 relative overflow-hidden rounded-[2px]">
            <p className="text-sm md:text-base text-[#a0a0a0] leading-7 font-light font-sans">
              The following interactive prototypes are personal explorations. They utilize <strong className="text-[#ccc] font-normal">synthetic datasets</strong> and do not represent peer-reviewed academic findings.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 border-t border-[#ffffff0a] flex justify-between items-end text-[10px] font-mono text-[#444] uppercase tracking-widest">
        ...
        <div>© 2026 Z.Qiu / All Systems Operational</div>
      </footer>
    </div>
  );
};
